      ...
      <div className="flex w-full  py-16 bg-gradient-to-b from-black to-red-rasta via-black text-white flex-col">
        <div className="flex w-full md:max-w-screen-xl md:mx-auto items-center items-center md:flex-row">
          <div className="leftSection md:w-6/12">
            ...
            <p className="mt-8">{DataBank.homepage.heroSection.desc}</p>
          ...
          <div className="images md:w-6/12 text-right">
            <LazyLoadImage
        ...
        <div className="flex w-full md:max-w-screen-xl md:mx-auto items-center items-center md:flex-row space-x-8 my-16">
